...
HARDWARE_PRESETS = {
    ...
    "Appliances": [
        ...
        {
            "key": "cisco-ise-xs",
            "label": "Cisco — ISE Extra Small (Lab)",
            "config": {
                "cpu_type": "host", "cores": 8, "sockets": 1,
        ...
        {
            "key": "cisco-ise-small-3615",
            "label": "Cisco — ISE Small (SNS 3615)",
            "config": {
                "cpu_type": "host", "cores": 16, "sockets": 1,
                "memory_mb": 32768, "net_model": "virtio", "disk_bus": "virtio",
                "os_type": "l26", "machine": "pc", "bios": "seabios",
                "vga_type": "std", "disk_cache": "none",
                "disk_iothread": False, "ballooning": False, "qemu_agent": False,
        ...
        {
            "key": "cisco-ise-medium-3655",
            "label": "Cisco — ISE Medium (SNS 3655)",
            "config": {
                "cpu_type": "host", "cores": 24, "sockets": 1,
        ...
        {
            "key": "cisco-ise-large-3695",
            "label": "Cisco — ISE Large (SNS 3695)",
            "config": {
                "cpu_type": "host", "cores": 24, "sockets": 1,
        ...
        {
            "key": "cisco-ise-small-3715",
            "label": "Cisco — ISE Small (SNS 3715)",
            "config": {
                "cpu_type": "host", "cores": 24, "sockets": 1,
                "memory_mb": 32768, "net_model": "virtio", "disk_bus": "virtio",
                "os_type": "l26", "machine": "pc", "bios": "seabios",
        ...
        {
            "key": "cisco-ise-medium-3755",
            "label": "Cisco — ISE Medium (SNS 3755)",
            "config": {
                "cpu_type": "host", "cores": 40, "sockets": 1,
                "memory_mb": 98304, "net_model": "virtio", "disk_bus": "virtio",
                "os_type": "l26", "machine": "pc", "bios": "seabios",
                "vga_type": "std", "disk_cache": "none",
                "disk_iothread": False, "ballooning": False, "qemu_agent": False,
        ...
        {
            "key": "cisco-ise-large-3795",
            "label": "Cisco — ISE Large (SNS 3795)",
            "config": {
                "cpu_type": "host", "cores": 40, "sockets": 1,
                "memory_mb": 262144, "net_model": "virtio", "disk_bus": "virtio",
                "os_type": "l26", "machine": "pc", "bios": "seabios",
        ...
        {
            "key": "cisco-ise-small-3815",
            "label": "Cisco — ISE Small (SNS 3815)",
            "config": {
                "cpu_type": "host", "cores": 32, "sockets": 1,
        ...
        {
            "key": "cisco-ise-medium-3855",
            "label": "Cisco — ISE Medium (SNS 3855)",
            "config": {
                "cpu_type": "host", "cores": 48, "sockets": 1,
        ...
        {
            "key": "cisco-ise-large-3895",
            "label": "Cisco — ISE Large (SNS 3895)",
            "config": {
                "cpu_type": "host", "cores": 48, "sockets": 1,
                "memory_mb": 262144, "net_model": "virtio", "disk_bus": "virtio",
                "os_type": "l26", "machine": "pc", "bios": "seabios",
